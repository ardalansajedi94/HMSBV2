...
import net.hotelairport.androidapp.LoggedInActivity;
import net.hotelairport.androidapp.Models.Basket;
import net.hotelairport.androidapp.R;
import net.hotelairport.androidapp.RetrofitWithRetry;
...
import net.hotelairport.androidapp.foodBasketFragment;
