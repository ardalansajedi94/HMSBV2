...
import net.hotelairport.androidapp.airportHotels.adapters.DailyPassengerDetailAdapter;
import net.hotelairport.androidapp.airportHotels.api.data.BookRoomController;
