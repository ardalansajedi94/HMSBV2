...
import net.hotelairport.androidapp.AuthActivity;

import net.hotelairport.androidapp.HotelNewsFragment;
import net.hotelairport.androidapp.R;
import net.hotelairport.androidapp.TabsFragment;
import net.hotelairport.androidapp.airportHotels.Auth.MyProfileFragment;
import net.hotelairport.androidapp.airportHotels.DailyStay.DailySearchFragment;
import net.hotelairport.androidapp.airportHotels.DailyStay.DailyStayBookFragment;
import net.hotelairport.androidapp.airportHotels.EventBus.DailyReserveResultBackEvent;
...
import net.hotelairport.androidapp.airportHotels.EventBus.ReturnButClick;
...
import net.hotelairport.androidapp.airportHotels.ShortStay.StayBookFragment;
