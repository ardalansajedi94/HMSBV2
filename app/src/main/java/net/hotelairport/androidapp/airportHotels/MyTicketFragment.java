...
import net.hotelairport.androidapp.airportHotels.adapters.PerchesAdapter;
import net.hotelairport.androidapp.airportHotels.api.data.HotelApi;
import net.hotelairport.androidapp.airportHotels.api.data.PurchaseController;
import net.hotelairport.androidapp.airportHotels.api.model.Voucher;
