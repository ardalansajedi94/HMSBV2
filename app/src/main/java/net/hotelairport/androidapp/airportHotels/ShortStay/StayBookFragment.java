...
import net.hotelairport.androidapp.airportHotels.adapters.RoomPagerAdapter;
...
public class StayBookFragment extends Fragment {
    ViewPager viewPager;
    TextView titleStrip;
    Button next;
    int position;
    ...
    public static StayBookFragment newInstance() {

        Bundle args = new Bundle();

        StayBookFragment fragment = new StayBookFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_stay_book, container , false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        final RoomPagerAdapter roomPagerAdapter = new RoomPagerAdapter(getActivity().getSupportFragmentManager() , getActivity());
